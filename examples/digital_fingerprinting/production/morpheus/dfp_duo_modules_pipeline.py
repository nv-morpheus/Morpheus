...
def run_pipeline(train_users,
    ...
    source_schema_filepath = persist_schema(cache_schema_dir, "duo_source_schema.pkl", source_schema)
    preprocess_schema_filepath = persist_schema(cache_schema_dir, "duo_preprocess_schema.pkl", preprocess_schema)
