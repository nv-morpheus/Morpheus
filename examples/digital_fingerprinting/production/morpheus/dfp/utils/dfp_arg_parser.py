...
class DFPArgParser:
    ...
    def __init__(self,
        ...
        self._model_name_formatter = mlflow_model_name_formatter  # f"DFP-{source}-" + "{user_id}"
        self._experiment_name_formatter = mlflow_experiment_name_formatter  # f"dfp/{source}/training/" + "{reg_model_name}"
