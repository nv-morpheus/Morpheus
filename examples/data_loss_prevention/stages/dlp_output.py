...
@register_stage("dlp-output", rename_options={"include_index_col": "--include-index-col"})
class DLPOutput(GpuAndCpuMixin, PassThruTypeMixin, SinglePortStage):
    """
    ...
    def _build_single(self, builder: mrc.Builder, input_node: mrc.SegmentObject) -> mrc.SegmentObject:
        node = builder.make_node(self.unique_name, ops.build(self._controller.node_fn))
