...
CUDA_VER=${CUDA_VER:-11.5.1}
CUDA_SHORT_VER=${CUDA_SHORT_VER:-11.5}
...
DOCKER_ARGS="${DOCKER_ARGS} --build-arg CUDA_SHORT_VER=${CUDA_SHORT_VER}"
...
echo "   CUDA_SHORT_VER  : ${CUDA_SHORT_VER}"
