...
class DFPFileBatcherStage(SinglePortStage):
    ...
    def __init__(self,
        ...
        self._no_time_window = no_time_window
    ...
    def on_data(self, file_objects: fsspec.core.OpenFiles):
        ...
        for file_object in file_objects:
            ...
            # Exclude any files outside the time window when no_time_window is False
            if not self._no_time_window:
