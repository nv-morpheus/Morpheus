...
// TODO(Yuchen): remove this test
TEST_F(TestControlMessage, TestJSONValues)
{
    auto json_values_1 = mrc::pymrc::JSONValues();
    auto json_values_2 = mrc::pymrc::JSONValues();
    auto json_values_3 = mrc::pymrc::JSONValues();

    json_values_3 = json_values_3.set_value("key4", 4);
    json_values_2 = json_values_2.set_value("key3", json_values_3);
    json_values_1 = json_values_1.set_value("key2", json_values_2);
    
    std::cout << "TestJSONValues" << std::endl;
    std::cout << json_values_1.to_json(mrc::pymrc::JSONValues::stringify) << std::endl;
    std::cout << json_values_1["key2"].to_json(mrc::pymrc::JSONValues::stringify) << std::endl;
    std::cout << json_values_1["key2"]["key3"]["key4"].to_json(mrc::pymrc::JSONValues::stringify) << std::endl;
    std::cout << json_values_1["key2/key3/key4"].to_json(mrc::pymrc::JSONValues::stringify) << std::endl;
