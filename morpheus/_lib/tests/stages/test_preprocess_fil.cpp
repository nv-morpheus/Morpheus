...
TEST_F(TestPreprocessFIL, TestProcessControlMessage)
{
    ...
    // Create PreProcessStage
    auto cm_stage    = std::make_shared<PreprocessFILStage>(std::vector<std::string>{"float_str1", "float_str2"});
