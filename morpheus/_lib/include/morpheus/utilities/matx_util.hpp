...
namespace morpheus {
    struct MatxUtil {
         ...
         * @return
         */
        static std::shared_ptr<rmm::device_buffer> create_seg_ids(size_t row_count, size_t fea_len, neo::TypeId output_type);
        ...
        /**
         * @brief Return an array of boolean where x[i,j] >= thresh_val, when by_row is true an Nx1 array will be returned with a
