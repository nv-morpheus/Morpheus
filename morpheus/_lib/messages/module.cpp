...
PYBIND11_MODULE(messages, _module)
{
    ...
    mrc::edge::EdgeConnector<std::shared_ptr<morpheus::MultiInferenceMessage>, mrc::pymrc::PyObjectHolder>::register_converter();
    mrc::edge::EdgeConnector<mrc::pymrc::PyObjectHolder, std::shared_ptr<morpheus::MultiInferenceMessage>>::register_converter();
