...
namespace morpheus {
    ...
    AddClassificationsStage::AddClassificationsStage(const neo::Segment &parent, const std::string &name,
                                                     float threshold, std::size_t num_class_labels,
    ...
    std::shared_ptr<AddClassificationsStage>
    AddClassificationStageInterfaceProxy::init(neo::Segment &parent, const std::string &name, float threshold,
