...
namespace morpheus {
    ...
    // ************ AddScoresStage **************************** //
    AddScoresStage::AddScoresStage(const neo::Segment &parent, const std::string &name, std::size_t num_class_labels,
    ...
    std::shared_ptr<AddScoresStage>
    AddScoresStageInterfaceProxy::init(neo::Segment &parent, const std::string &name, std::size_t num_class_labels,
                                       std::map<std::size_t, std::string> idx2label) {
