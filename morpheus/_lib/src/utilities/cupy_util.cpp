...
namespace morpheus {
    ...
    pybind11::object CupyUtil::tensor_to_cupy(const neo::TensorObject &tensor) {
        ...
        return ndarray(
                pybind11::cast<pybind11::tuple>(shape_list), dtype, memptr,
                pybind11::cast<pybind11::tuple>(stride_list));
    }

    neo::TensorObject CupyUtil::cupy_to_tensor(pybind11::object cupy_array) {
        ...
        auto tensor =
                Tensor::create(std::make_shared<rmm::device_buffer>((void const *) data_ptr, size,
