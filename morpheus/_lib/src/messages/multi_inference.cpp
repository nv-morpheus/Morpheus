...
namespace morpheus {
    ...
    MultiInferenceMessage::MultiInferenceMessage(std::shared_ptr<morpheus::MessageMeta> meta, std::size_t mess_offset,
                                                 std::size_t mess_count, std::shared_ptr<morpheus::InferenceMemory> memory,
    ...
    const neo::TensorObject MultiInferenceMessage::get_input(const std::string &name) const {
    ...
    const void MultiInferenceMessage::set_input(const std::string &name, const neo::TensorObject &value) {
    ...
    MultiInferenceMessageInterfaceProxy::init(std::shared_ptr<MessageMeta> meta, cudf::size_type mess_offset,
    ...
    MultiInferenceMessageInterfaceProxy::memory(MultiInferenceMessage &self) {
        return self.memory;
    }
    ...
    pybind11::object
    MultiInferenceMessageInterfaceProxy::get_input(MultiInferenceMessage &self, const std::string &name) {
    ...
    std::shared_ptr<MultiInferenceMessage>
    MultiInferenceMessageInterfaceProxy::get_slice(MultiInferenceMessage &self, std::size_t start, std::size_t stop) {
