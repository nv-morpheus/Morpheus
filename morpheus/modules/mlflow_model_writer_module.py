...
def make_mlflow_model_writer_module(module_id, namespace):
    """
    This function creates a `MLFlowModelWriter` module and registers it in the module registry.
    This module uploads trained modules to the mlflow server.
