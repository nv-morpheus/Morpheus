...
def test_filter_column(config, tmp_path, filter_probs_pandas_df, use_conv_msg, do_copy, threshold, field_name):
    ...
    expected_df = np.around(filter_probs_pandas_df[filter_probs_pandas_df[field_name] > threshold], 2)
