...
* Model expects cloudtrail logs with specific features that match the training dataset. Data lacking the required features or requiring a different feature set may not be compatible with the model.
...
* No PII was used in the training of this pretrained DFP model. The dataset used is synthetic and generated using the python faker package. Any resemblance to real individuals is purely coincidental.
