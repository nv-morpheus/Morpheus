...
**Link:**
* https://github.com/nv-morpheus/Morpheus/blob/branch-25.06/models/datasets/training-data/root-cause-training-data.csv <br>
...
**Link:**
* https://github.com/nv-morpheus/Morpheus/blob/branch-25.06/models/datasets/validation-data/root-cause-validation-data-input.jsonlines  <br>
