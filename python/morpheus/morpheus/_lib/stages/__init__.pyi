...
class AddClassificationsStage(mrc.core.segment.SegmentObject):
    ...
    def __init__(self, builder: mrc.core.segment.Builder, name: str, idx2label: typing.Dict[int, str],
...
class FileSourceStage(mrc.core.segment.SegmentObject):
    ...
    def __init__(self,
                 ...
                 repeat: int,
                 filter_null: bool,
                 filter_null_columns: typing.List[str],
...
class InferenceClientStage(mrc.core.segment.SegmentObject):
    ...
    def __init__(self,
                 ...
                 input_mapping: typing.Dict[str, str] = {},
                 output_mapping: typing.Dict[str, str] = {}) -> None:
        ...
...
class KafkaSourceStage(mrc.core.segment.SegmentObject):
    ...
    def __init__(self,
                 ...
                 oauth_callback: typing.Optional[function] = None) -> None:
        ...
...
class PreallocateControlMessageStage(mrc.core.segment.SegmentObject):
    ...
    def __init__(self,
                 builder: mrc.core.segment.Builder,
                 name: str,
                 needed_columns: typing.List[typing.Tuple[str, morpheus._lib.common.TypeId]]) -> None:
        ...
...
class RouterControlMessageComponentStage(mrc.core.segment.SegmentObject):
    ...
    def __init__(self,
                 ...
                 name: str,
                 *,
                 router_keys: typing.List[str],
                 key_fn: typing.Callable[[morpheus._lib.messages.ControlMessage], str]) -> None:
        ...
